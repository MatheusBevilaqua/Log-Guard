...
VALUES 
(1, 'Funcionario 9A', 'funcionario9a@empresaa.com', 'senha123senha123', 'ADMINISTRADOR');
UPDATE usuario SET tipoPerfilUsuario = "DESATIVADO" WHERE idUsuario = 2;

select * from usuario;

SELECT * FROM usuario WHERE fkEmpresaUsuario = 1 AND tipoPerfilUsuario != 'DESATIVADO';
...
INSERT INTO usuario (fkEmpresaUsuario, nomeUsuario, emailUsuario, senhaUsuario, tipoPerfilUsuario) 
VALUES 
(3, 'Funcionario 17C', 'funcionario17c@empresac.com', 'senha123', 'ADMINISTRADOR');
select*from usuario;
UPDATE usuario SET tipoPerfilUsuario = "ADMINISTRADOR" WHERE idUsuario = 50;
UPDATE usuario SET nomeUsuario = "A", emailUsuario = "A", senhaUsuario = "A", tipoPerfilUsuario = "COMUM" WHERE idUsuario = 49;
