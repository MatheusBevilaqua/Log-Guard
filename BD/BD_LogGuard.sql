...
idEmpresa INT PRIMARY KEY auto_increment,CREATE DATABASE logGuard;
USE logGuard;
...
SELECT maquina.nomeMaquina AS nome_maquina, captura.registro AS uso_banda, captura.dtCriacaoCaptura AS hora_captura, DATE_FORMAT(captura.dtCriacaoCaptura, '%H:%i:%s') AS momento_grafico FROM maquina JOIN captura ON
  maquina.idMaquina = captura.fkMaquinaCaptura WHERE maquina.fkLocalidadeMaquina = 1 AND captura.fkRecursoCaptura = 4 ORDER BY captura.dtCriacaoCaptura DESC LIMIT 7;
...
INSERT INTO captura (fkMaquinaCaptura, fkRecursoCaptura, fkMaquinaRecursoCaptura, registro, tem_problema, dtCriacaoCaptura) VALUES (13, 2, 2, 80,1, '2024-12-08 01:00:00');
INSERT INTO captura (fkMaquinaCaptura, fkRecursoCaptura, fkMaquinaRecursoCaptura, registro, tem_problema, dtCriacaoCaptura) VALUES (13, 2, 2, 86,1, '2024-12-08 02:00:00');
INSERT INTO captura (fkMaquinaCaptura, fkRecursoCaptura, fkMaquinaRecursoCaptura, registro, tem_problema, dtCriacaoCaptura) VALUES (13, 2, 2, 90,1, '2024-12-08 03:00:00');
INSERT INTO captura (fkMaquinaCaptura, fkRecursoCaptura, fkMaquinaRecursoCaptura, registro, tem_problema, dtCriacaoCaptura) VALUES (13, 2, 2, 91,1, '2024-12-08 04:00:00');
INSERT INTO captura (fkMaquinaCaptura, fkRecursoCaptura, fkMaquinaRecursoCaptura, registro, tem_problema, dtCriacaoCaptura) VALUES (13, 2, 2, 92,1, '2024-12-08 05:00:00');
INSERT INTO captura (fkMaquinaCaptura, fkRecursoCaptura, fkMaquinaRecursoCaptura, registro, tem_problema, dtCriacaoCaptura) VALUES (13, 2, 2, 87,1, '2024-12-08 06:00:00');
INSERT INTO captura (fkMaquinaCaptura, fkRecursoCaptura, fkMaquinaRecursoCaptura, registro, tem_problema, dtCriacaoCaptura) VALUES (13, 1, 1, 40,1, '2024-12-08 06:00:00');
INSERT INTO captura (fkMaquinaCaptura, fkRecursoCaptura, fkMaquinaRecursoCaptura, registro, tem_problema, dtCriacaoCaptura) VALUES (13, 4, 1, 100,1, '2024-12-08 06:00:00');
INSERT INTO captura (fkMaquinaCaptura, fkRecursoCaptura, fkMaquinaRecursoCaptura, registro, tem_problema, dtCriacaoCaptura) VALUES (13, 4, 2, 20,1, '2024-12-08 06:00:00');
INSERT INTO captura (fkMaquinaCaptura, fkRecursoCaptura, fkMaquinaRecursoCaptura, registro, tem_problema, dtCriacaoCaptura) VALUES (13, 3, 1, 100,1, '2024-12-08 06:00:00');
INSERT INTO captura (fkMaquinaCaptura, fkRecursoCaptura, fkMaquinaRecursoCaptura, registro, tem_problema, dtCriacaoCaptura) VALUES (13, 3, 2, 20,1, '2024-12-08 06:00:00');
